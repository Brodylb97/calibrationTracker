...
Usage:
  py release.py              # prompt for version
  py release.py 1.3.6        # use version 1.3.6
  py release.py --no-commit # do everything except git commit
"""
...
ISS_FILE = SCRIPT_DIR / "CalibrationTracker.iss"
...
def build_executable() -> None:
    ...
    spec_file = SCRIPT_DIR / "CalibrationTracker.spec"
    ...
    restart_helper = SCRIPT_DIR / "restart_helper" / "RestartHelper.exe"
    dist_exe = SCRIPT_DIR / "dist" / "RestartHelper.exe"
...
def main() -> None:
    ...
    run_cmd([sys.executable, "build_update_package.py"], "3. Build update package")
